---
title: "Plotting Average MFLOPS vs. Log10 N"
...
```{r}
data <- read_csv("a1/data/part_2_data.csv", show_col_types = FALSE)
```
...
plot <- summarized_data %>%
  ...
  labs(
    x = "log10 N",
    y = "MFLOPS",
    title = "Average MFLOPS vs. Log10 N",
    color = "Legend"
  ) +
  theme_minimal() +
  theme(
...
ggsave("a1/data/part_2_plot.pdf", plot, width = 6, height = 8, dpi = 600)
```